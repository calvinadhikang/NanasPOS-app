        ...
        <div class="rounded-md w-1/2 bg-slate-300 p-4 shadow-xl">
            ...
            <form action="">
                ...
                <div class="form-control w-full">
                    ...
                    <input type="text" placeholder="Masukan Username..." class="input input-bordered w-full" />
                </div>
                <div class="form-control w-full">
                    <label class="label">
                        <span class="label-text font-semibold text-lg">Password</span>
                    </label>
                    <input type="password" placeholder="Masukan Password..." class="input input-bordered w-full" />
                </div>
