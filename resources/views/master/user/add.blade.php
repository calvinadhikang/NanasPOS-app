...
<div class="text-xl breadcrumbs">
    <ul>
        ...
        <li class="font-bold"><h1>Tambah User</h1></li>
    </ul>
</div>
    ...
    <form method="POST">
        ...
        <div class="flex flex-wrap my-5 ">
            ...
            <div class="form-control w-full md:w-1/2">
                ...
                <input type="number" placeholder="1000" class="input input-bordered w-full" name="telp" required/>
            </div>
            <div class="form-control w-full md:w-1/2 md:pe-2">
                <label class="label">
                ...
                <input type="text" placeholder="1000" class="input input-bordered w-full" name="username" required/>
            </div>
            <div class="form-control w-full md:w-1/2">
                <label class="label">
                ...
                <input type="password" placeholder="1000" class="input input-bordered w-full" name="password" required/>
            </div>
            <div class="form-control w-full md:w-1/2 md:pe-2">
                <label class="label">
